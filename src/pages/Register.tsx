          ...
          <form onSubmit={handleRegister} className="space-y-5">
            <div>
              <input
                ...
                className="w-full px-4 py-3.5 bg-zinc-800 border border-zinc-700 rounded-lg text-white placeholder-zinc-500 focus:outline-none focus:border-blue-500"
              />
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3.5 bg-zinc-800 border border-zinc-700 rounded-lg text-white placeholder-zinc-500 focus:outline-none focus:border-blue-500 pr-12"
              />
              <button
                type="button"
            ...
            <button
              type="submit"
              className="w-full py-3.5 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-all"
            >
              Sign Up
            </button>
          </form>
